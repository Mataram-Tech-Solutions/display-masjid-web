    ...
    <div class="col-12">
      <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>Edit Data Ulama</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
                <form action="{{ route('ulama.update', $oldval->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row px-4">
                        <!-- Form Sholat -->
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama', $oldval->name) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="gender" name="gender" required>
                                    ...
                                    <option value="ustadz" {{ old('gender', $oldval->ustd ?? '') == 'ustadz' ? 'selected' : '' }}>
                                        Ustadz
                                    </option>
                                    <option value="ustadzah" {{ old('gender', $oldval->ustd ?? '') == 'ustadzah' ? 'selected' : '' }}>
                                        Ustadzah
                                    </option>
                                </select>
                            </div>
