        ...
        <div class="card-body px-0 pt-0 pb-0">
          <div class="table-responsive p-0">
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Masjid</th>
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Alamat Masjid</th>
                  <th class="text-secondary opacity-7 ms-4"></th>
                </tr>
              </thead>
              <tbody>
                @foreach ($masjid as $masjids)
                <tr>
                    <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">{{ $masjids->name }}</span>
                    </td>
                    <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">{{ $masjids->alamat }} H</span>
                    </td>
                    <td class="align-middle text-center">
                        <form action="{{ route('masjid.edit', $masjids->id) }}" method="GET">
