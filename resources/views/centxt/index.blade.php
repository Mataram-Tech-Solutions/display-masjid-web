    ...
    <div class="col-12">
      <div class="card mb-4">
            ...
            <table class="table align-items-center mb-0">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle text-center">
                        <form action="{{ route('centxt.edit', $centxts->id) }}" method="GET">
                            <button type="submit" class="btn btn-sm btn-warning">Edit Data</button>
                        </form>
                    </td>
                    <td class="align-middle text-center">
                        <form action="{{ route('centxt.destroy', $centxts->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button  type="button" 
                            ...
                            onclick="setDeleteForm('{{ route('centxt.destroy', $centxts->id) }}')">Hapus Data</button>
                        </form>
                    </td>
                </tr>
                @endforeach 
        ...
        <div class="card-footer pb-0 pt-2 d-flex justify-content-end align-items-center">
            <form action="{{ route('centxt.create') }}" method="GET">
                <button type="submit" class="btn btn-sm btn-primary">Tambah Hadist</button>
            </form>
        </div>        
      </div>
    </div>
