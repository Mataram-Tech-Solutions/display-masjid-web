<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="#">
      <img src="{{ asset('images/fathtronikLogo.png') }}" width="100%" height="auto" class="navbar-brand-img h-100" alt="main_logo">
    </a>
  </div>
  <hr class="horizontal dark mt-0">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ in_array(Route::currentRouteName(), ['setwaktu', 'setwaktu-edit']) ? 'active' : '' }}" href="{{ route('setwaktu') }}">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-world-2 text-dark text-sm opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">Setting Waktu</span>
        </a>
      </li>
