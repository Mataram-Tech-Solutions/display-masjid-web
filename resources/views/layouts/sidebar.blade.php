<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ in_array(Route::currentRouteName(), ['jadwalkajian.index', 'jadwalkajian.edit']) ? 'active' : '' }}" href="{{ route('jadwalkajian.index') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link " href="../pages/rtl.html">
            ...
            <span class="nav-link-text ms-1">Muhharam</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="../pages/rtl.html">
        ...
        <li class="nav-item">
          <a class="nav-link " href="../pages/rtl.html">
            ...
            <span class="nav-link-text ms-1">Konten Center Text</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="../pages/rtl.html">
